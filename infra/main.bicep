...
output primaryAppInsightsName string = webApp.outputs.primaryAppInsightsName
output primaryManagedCertName string = webApp.outputs.primaryManagedCertName
...
output secondaryAppInsightsName string = webApp.outputs.secondaryAppInsightsName
output secondaryManagedCertName string = webApp.outputs.secondaryManagedCertName
